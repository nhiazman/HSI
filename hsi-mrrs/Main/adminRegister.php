...
<html>
    <body>
        <div class="background"><br><br>
            ...
            <h1><center>REGISTER STAFF</center></h1>
            ...
            <div class="container">
                ...
                <form action="adminAdd.php" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="right-col">
                            <input type="text" id="sID" name="sID" placeholder="Enter administrator ID" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="right-col">
                            <input type="text" id="aName" name="aName" placeholder="Enter administrator name" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="right-col">
                            <input type="text" id="aUsername" name="aUsername" placeholder="Enter administrator username" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="right-col">
                            <input type="text" id="aPassword" name="aPassword" placeholder="Enter administrator password" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="right-col">
                            <input type="text" id="aContact" name="aContact" placeholder="Enter administrator contact" required>
                        </div>
                    </div>        
                    ...
                    <div class="row">
                        ...
                        <div class="right-col">
                            <input type="text" id="aExt" name="aExt" placeholder="Enter administrator extension" required>
                        </div>
                    </div>    
