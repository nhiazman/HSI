    ...
    <div class="background"><br><br>
      ...
      <div class="container">
        ...
        <form name="login" method="post" action="loginFunction.php">
          ...
          <div class="row">
            <div class="left-col">
              <label for="uname" style="font-family: Arial; font-size: 14px; font-weight: bold;">Username:</label>
            </div>
            <div class="right-col">
          ...
          <div class="row">
            <center>
              <button type="submit" style="border-radius: 20px; font-family:Times New Roman;">LOGIN</button>
              <br><br><br>
            </center>
          </div>
