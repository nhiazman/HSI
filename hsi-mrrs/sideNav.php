...
<html>
	...
	<body> 
		<div class="side-nav">
			...
			<hr>
			<a href="../Reservation/reservePage.php" <?php echo ($current_page == 'reservePage.php') ? 'class="active-link"' : ''; ?>>MY RESERVATION</a>
			<hr>
			<a href="../Main/managePage.php" <?php echo ($current_page == 'managePage.php') ? 'class="active-link"' : ''; ?>>MANAGE</a>
			<hr>
			<a href="../Profile/profilePage.php" <?php echo ($current_page == 'profilePage.php') ? 'class="active-link"' : ''; ?>>PROFILE</a>
			<hr>
			<div class="log-out">
