...
<html>
    <body>
        <nav class="topnav" id="myTopnav">
            ...
            <a class="active" href="searchPage.php">
                <i class="fa fa-home"></i>
            </a>
        </nav>

        <div class="background"><br><br><br><br><br><br>
            ...
            <form method="POST" action="" id="searchForm">
                <div class="search">
                    ...
                    <button id="clearButton" type="button" onclick="location.href='searchPage.php'">CLEAR</button>
                ...
                <!-- Error Message-->
                <center>
                    <div id="errorMessage" style="color: red; display: none;"><br><br>Please fill in the search field.</div>
                </center>
            </form>
                ...
                <?php
                    if ($resultsFound) {
                        ...
                        foreach ($searchResults as $row) {
                            ...
                            echo '<td><input class="custom-button" type="button" onclick="location.href=\'staffView.php?staff_ID=' . $row['staff_ID'] . '\'" value="View"></td>';
                            echo '</tr>';
                        }
                        echo '</table>';
                    } elseif (isset($_POST['formSubmitted'])) {
                        // Display "No results found" message when the form is submitted and no results are found
                        echo '<div style="text-align:center;color:red;">Data tidak dijumpai atau masih dalam proses pendaftaran setelah borang User ID diterima.<br>Sila hubungi 1207 untuk ketahui lebih lanjut. Terima kasih.</div>';
                    }
                ?>
            </center>
