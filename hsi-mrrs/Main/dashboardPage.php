<?php
  ...
  //For Equipment
  $Esql ="SELECT COUNT(*) AS Erow_count FROM reservation where reserve_Date = '$currDate' AND equipment = 1";
  $Eresult = mysqli_query($connect, $Esql);
  $Erow = mysqli_fetch_assoc($Eresult);
  $ErowCount = $Erow['Erow_count'];
?>
      ...
      <table id="staff" class="myTable">
            ...
            $offset = ($currentPage - 1) * $recordsPerPage;
                ...
                AS formatted_log_Time,  
								...
								FROM log
								LEFT JOIN staff
								ON log.staff_ID = staff.staff_ID
        ...
        <div class="pagination">
          ...
          if ($currentPage > 1) {
            echo "<a href='adminDashboard.php?page=" . ($currentPage - 1) . "'>Previous</a>";
          }

          // Display first page
          $style = ($currentPage == 1) ? "class='current-page'" : "";
          echo "<a href='adminDashboard.php?page=1' $style>1</a>";
          ...
          for ($i = max(2, $currentPage - 2); $i <= min($totalPages - 1, $currentPage + 2); $i++) {
            ...
            echo "<a href='adminDashboard.php?page=$i' $style>$i</a>";
          }
          ...
          echo "<a href='adminDashboard.php?page=$totalPages' $style>$totalPages</a>";

          // Display "Next" link if not on the last page
          if ($currentPage < $totalPages) {
            echo "<a href='adminDashboard.php?page=" . ($currentPage + 1) . "'>Next</a>";
          }
