...
<html>
	<body>
		...
		<div class="background"><br><br>
			...
			<div class="register">
				<input type='button' onclick='location.href="departmentRegister.php"' value='New Department'>
			</div> 
				...
				<?php
					...
					if(mysqli_num_rows($result) > 0) 
					{
						foreach($result as $row) { 
							...
							echo"<td>$dName</td>";
							echo"<td><input class='custom-button' type='button' onclick='location.href=\"departmentEdit.php?id=$dID\"' value='Edit'> ";
							echo"<input class='delete-button' type='button' onclick='delFunction(\"$dID\")' value='Delete'></td>";
							echo"</tr>";
						}
					}
...
<script>
	function delFunction(dID) {
		var r = confirm("Are you sure you want to remove this department?");
		if(r == true) { 
			location.href="departmentDelete.php?id=" + dID;
		}
    }
</script>