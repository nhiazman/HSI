...
<html>
    <body>
        <div class="background"><br><br>
            ...
            <h1 style="color: #fff; font-family: 'Barlow'; font-size: 60px;"><center>REGISTER DEPARTMENT</center></h1>
            ...
            <div class="container">
                ...
                <form action="departmentAdd.php" method="post">
                    ...
                    <div class="row">
                        <div class="left-col">
                            <label for="dName" style= "font-family: Arial; font-size: 14px;">Name:</label>
                        </div>
                        <div class="right-col">
