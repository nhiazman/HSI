<?php
	...
	$departmentresult = mysqli_query($connect, $Dsql);
        ...
        <h1><center>NEW RESERVATION</center></h1>
            ...
            <div class="container">
                ...
                <form name="register" method="post" action="reservationAdd.php">
                    ...
                    <div class="row">
                        <div class="left-col">
                            <label for="mTitle" style= "font-family: Arial; font-size: 14px;">Meeting Title:</label>
                        </div>
                        <div class="right-col">
                            <input type="text" id="mTitle" name="mTitle" placeholder="Enter Meeting Title.." required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            echo '<input type="date" id="mDate" name="mDate" placeholder="Enter Meeting Date.." min="' . $currDate . '" value="' . $selectedDate . '" required />';
                        ?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="left-col">
                            <label for="pName" style= "font-family: Arial; font-size: 14px;">Person In-Charge:</label>
                        </div>
                        <div class="right-col">
                            <input type="text" id="pName" name="pName" placeholder="Enter the PIC name.." required>
                        </div>
                    </div>

                    <div class="row">
                        <div class="left-col">
                            <label for="pDept" style= "font-family: Arial; font-size: 14px;">Department:</label>
                        </div>
                        <div class="right-col">
                            <input list="deptList" id="pDept" name="pDept" required placeholder="Choose PIC department">
                            <datalist id="deptList">
                                <?php
                                    while ($Drow = mysqli_fetch_array($departmentresult)) {
                                        echo '<option value="' . $Drow['department_ID'] . ' : ' . $Drow['department_Name'] . '">';
                                    }
                                ?>
                            </datalist>
                        </div>
                    ...
                    <div class="row">
                        <div class="left-col">
                            <label for="pContact" style= "font-family: Arial; font-size: 14px;">Contact:</label>
                        </div>
                        <div class="right-col">
                            <input type="text" id="pContact" name="pContact" placeholder="Example: 60123456789" required>
                        </div>
                    </div>

                    <div class="row">
                        <div class="left-col">
                            <label for="pNotes" style= "font-family: Arial; font-size: 14px;">Notes:</label>
                        </div>
                        <div class="right-col">
                            <input type="text" id="pNotes" name="pNotes" placeholder="Example: Notebook, Webcam ..">
                        </div>
                    </div>
