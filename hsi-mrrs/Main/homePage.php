                              ...
                              if ($i < $startday) echo "<td class='$class' bgcolor='white' width='80px' height='80px'></td>";
                                ...
                                elseif ($isCurrentMonth) {
                                  ...
                                  if ($isPastDate) {
                                    ...
                                    //     echo "<td class='$class' bgcolor='#D21404' width='80px' height='80px'><a style='text-decoration:none; color:white; font-weight:bold; font-size:30px; font-family:Arial; text-shadow: 1px 1px 4px black;' href='homeDetails.php?date=$currentDate'>" . ($i - $startday + 1) . "</a></td>";
                                    // } elseif ($j == $day) {
                                    //     echo "<td class='$class' bgcolor='#D21404' width='80px' height='80px'><a style='text-decoration:none; color:white; font-weight:bold; font-size:30px; font-family:Arial; text-shadow: 1px 1px 4px black;' href='homeDetails.php?date=$currentDate'>" . ($i - $startday + 1) . "</a></td>";
                                    // } elseif ($reservationCount > 0) {
                                    //     echo "<td class='$class' bgcolor='white' width='80px' height='80px'><a style='text-decoration:none; color:black; font-weight:bold; font-size:20px; font-family:Arial;' href='homeDetails.php?date=$currentDate'>" . ($i - $startday + 1) . "</a></td>";
                                    // } else {
                                    //     echo "<td class='$class' bgcolor='white' width='80px' height='80px'><a style='text-decoration:none; color:black; font-weight:bold; font-size:20px; font-family:Arial;' href='homeDetails.php?date=$currentDate'>" . ($i - $startday + 1) . "</a></td>";
                                    // }
