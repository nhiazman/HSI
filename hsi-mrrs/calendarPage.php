...
<html>
    <body>
        <nav class="topnav" id="myTopnav">
            ...
            <a class="active" href="calendarPage.php">
                                ...
                                elseif ($isCurrentMonth) {
                                  ...
                                  if ($isPastDate) {
                                      ...
                                      if ($j == $day && $reservationCount > 0) {
                                        ...
                                        echo "<button style='text-decoration:none; color:white; font-weight:bold; font-size:30px; font-family:Arial; text-shadow: 1px 1px 4px black; width: 100%; height: 100%; background-color: transparent; border: none; padding: 0; margin: 0; cursor: pointer;' onclick='window.location.href=\"calendarDetails.php?date=$currentDate\";'>";
                                        echo ($i - $startday + 1);
                                        echo "</button>";
                                        echo "</td>";
                                    } elseif ($j == $day) {
                                        ...
                                        echo "<button style='text-decoration:none; color:black; font-weight:bold; font-size:23px; font-family:Arial; width: 100%; height: 100%; background-color: transparent; border: none; padding: 0; margin: 0; cursor: pointer;' onclick='window.location.href=\"calendarDetails.php?date=$currentDate\";'>";
                                        echo ($i - $startday + 1);
                                        echo "</button>";
                                        echo "</td>";
                                    } else {
