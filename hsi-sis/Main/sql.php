<?php 
  ...
  if (isset($_GET['staff_ID'])) {
    ...
    // Handle the case where staff_ID is not provided in the URL
      ...
      <div class="container">
        ...
        <form action="staffEdit.php" method="post">
          ...
          <div class="row">
            ...
            <div class="right-col">
              <select id="sDept" name="staffDept" required>
                <?php
                  while($Drow = mysqli_fetch_array($deptResult)) {
                    $deptID = $Drow['dept_ID'];
                    $deptName = $Drow['dept_Name'];
          
                    // Check if the current department is the selected one
                    $selected = ($deptID == $sDept) ? 'selected' : '';
          ...
          <div class="row">
            <div class="left-col">
              <label for="sWC">Ward / Clinic:</label>
            </div>
            <div class="right-col">
          ...
          <div class="row">
            <center>
              <input class="custom-button" type="button" value="Back" onclick='location.href="staffView.php?staff_ID=<?php echo $sID; ?>"'>
